...
const emptyForm = {
  name: '', dailyRate: '', validityDays: '30', discount: '',
  productId: '',
...
export function ProductPlansPage() {
  ...
  const openCreate = () => {
    setEditingPlan(null);
    setForm({ ...emptyForm, productId: productId! });
    setShowModal(true);
  };
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-lg space-y-4 my-8">
            ...
            <div>
              ...
              <input required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="Ex: Plano Anual" className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Diaria (R$)</label>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm font-medium text-gray-700">Usuarios ilimitados</span>
              </label>
              <label className="flex items-center gap-2 cursor-pointer">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-sm font-medium text-gray-700">Atualizacoes</span>
              </label>
            </div>
      ...
      {deleteTarget && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm">
            ...
            <p className="text-sm text-gray-600 mb-4">Tem certeza que deseja excluir o plano <strong>{deleteTarget.name}</strong>? Esta acao nao pode ser desfeita.</p>
